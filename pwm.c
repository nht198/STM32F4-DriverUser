...
/**
  ...
  *
*/
void PWMInit(uint32_t RCC_AHB1Periph,GPIO_TypeDef* GPIOx,uint16_t GPIO_PinSource,uint8_t GPIO_AF,
            uint16_t GPIO_Pin,TIM_TypeDef* TIMx,uint16_t TIM_PeriodValue)
{
